...
function HeroSection() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-transparent flex items-center justify-center">
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200 mb-8 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-blue-200/50 cursor-pointer">
            <svg
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto mb-8">
            <input
              ...
              className="flex w-full rounded-md border border-gray-300 px-3 py-2 text-lg bg-white/90 backdrop-blur-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 flex-1 h-12"
