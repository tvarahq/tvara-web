        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-300 mb-6">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-[#4384c1]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto mb-8">
              <input
                ...
                className="flex w-full rounded-md border border-gray-300 px-3 py-2 text-lg bg-white/90 backdrop-blur-sm placeholder:text-gray-500 placeholder:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 flex-1 h-12"
