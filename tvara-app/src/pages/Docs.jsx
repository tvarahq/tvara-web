  ...
  const renderContent = (contentItem, index) => {
    switch (contentItem.type) {
      ...
      case 'code':
        ...
        const highlightedCode = getSyntaxHighlighting(contentItem.content, contentItem.language);
    ...
    <div className="bg-background h-screen flex">
      ...
      <div className="flex-1 flex flex-col text-white">
        ...
        <div className="flex-1 flex flex-col gap-8 px-20 py-10 overflow-y-auto">
          {currentContent ? (
            <>
              <span className="text-4xl font-bold">{currentContent.title}</span>
              <span className="text-xl font-light text-gray-300">{currentContent.subtitle}</span>
            ...
            <>
              ...
              <span className="text-xl font-light">Please select a valid section from the sidebar.</span>
            </>
          )}
        </div>
      </div>
