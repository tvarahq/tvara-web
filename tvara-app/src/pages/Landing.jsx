...
function Landing() {
  return (
    <div className="relative h-screen w-full bg-background text-white">
      <div className="flex justify-center pt-8">
        <NavBar />
      </div>

      <div className="absolute bottom-8 left-24 right-24 flex justify-between items-center">
        <div className="w-full">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 text-2xl text-gray-300">
              ...
              minutes. With 10,000+ tools and an agentic engine, turn
              ideas into adaptive workflows that keep running while you sleep.
            </p>
          </div>
