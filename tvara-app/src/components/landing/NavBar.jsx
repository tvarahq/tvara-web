    ...
    <>
      ...
      <nav className="relative translate-y-10 flex items-center justify-between text-white rounded-[20px] px-4 md:px-9 py-3 font-sans z-50">
        ...
        <div className="relative z-10 w-full flex items-center justify-between">
          {/* Logo */}
          <Link to="/">
            <img src={navbar_logo} alt="Logo" className="h-6 md:h-8 cursor-pointer" />
          </Link>
          ...
          <div className="hidden md:flex gap-4">
            <a href="https://github.com/tvarahq/tvara" target="_blank" rel="noreferrer">
            ...
            <a href="https://tvara-workspace.slack.com/archives/C099B0WMYKZ" target="_blank" rel="noreferrer">
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 bg-black/50 backdrop-blur-sm z-40 transition-opacity duration-300 md:hidden ${isMobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <div className={`fixed top-20 left-1/2 transform -translate-x-1/2 w-[95%] bg-[#222020] rounded-[20px] border border-[#5e5656]/30 transition-all duration-300 ${isMobileMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'}`}>
